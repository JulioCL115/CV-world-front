        ...
        <div className={styles.topbar}>
            ...
            <div className={styles.containerRight}>
                ...
                <div className={styles.containerLogin}>
                    <Link className={styles.txtRegular16Underlined}  to="/signin"> {tokenInfo?.displayName || tokenInfo?.name ? tokenInfo.displayName || tokenInfo.name : "Iniciar sesión"}</Link>
                ...
                </div>{tokenInfo?.uid ? <button className="dropdown-item" onClick={logOut}>
                          Cerrar Sesión
                        </button> : null
                }
            </div>
