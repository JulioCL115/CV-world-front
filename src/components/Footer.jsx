    ...
    return (
        <div className='footer'>
            <div className='vertical'>
                ...
                <p className='txt'>Mantenete al tanto de nuestras novedades y lanzamientos
                    suscribiéndote a nuestro newsletter.</p>
                <div className='horizontal'>
                    <input className='input' name="email" type='text' placeholder='Ingresá tu mail...' value={email} onChange={handleChange} />
