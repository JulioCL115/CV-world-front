                ...
                <div className={styles.horizontal} id={styles.containerTop}>
                    ...
                    <div className={styles.horizontal} id={styles.containerTopRight}>
                            ...
                            <div className={styles.horizontal}>
                                <svg className={styles.icn}
                                    ...
                                    <g fill="#ffffff"
                                        ...
                                        strokeMiterlimit="10"
                                        strokeDasharray=""
                                        strokeDashoffset="0"  ><g transform="scale(5.12,5.12)"><path d="M5.91992,6l14.66211,21.375l-14.35156,16.625h3.17969l12.57617,-14.57812l10,14.57813h12.01367l-15.31836,-22.33008l13.51758,-15.66992h-3.16992l-11.75391,13.61719l-9.3418,-13.61719zM9.7168,8h7.16406l23.32227,34h-7.16406z"></path></g></g>
                                </svg>
                        ...
                        <div className={styles.vertical}>
                            ...
                            <div className={styles.horizontal}>
                                <svg className={styles.icn} xmlns="http://www.w3.org/2000/svg" fill="none" color="white" width="20px" height="20px" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" class="w-6 h-6">
