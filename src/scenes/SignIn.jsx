  ...
  return (
    <div className={styles.signIn}>
      ...
      <div className={styles.containerRight}>
          ...
          <div className={styles.vertical}>
            ...
            <div className={styles.containerPassword}>
              ...
              <button
                ...
                aria-label={loginInfo.showPassword ? 'Hide password' : 'Show password'}
              >
                {login.showPassword ? (
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#3e3e70" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <button className={styles.btnGoogle} onClick={handleClick}>
